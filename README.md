...
Table: CUSTOMERS, VEHICLES, SERVICES, PARTS, TOWING, MECHANICS.             
Description: Customer ID, name, and contact information, Vehicle ID, type, make/model, linked to custoomer,Core service records — repair type, cost, mechanic, date
 Parts used per service with pricing, Towing events linked to service records Mechanic ID and name, linked to services
